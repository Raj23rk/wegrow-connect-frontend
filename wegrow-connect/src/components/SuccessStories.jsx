...
const successVideos = [
  {
    ...
    founder: 'Bootcamp Session',
    company: 'AI Tools Bootcamp',
    videoUrl: '/videos/video1.mp4',
  },
  {
    id: 2,
    title: 'Digital Marketing Strategies',
    founder: 'Future Marketer',
    company: 'Digital Marketing',
    videoUrl: '/videos/video2.mp4',
  },
  {
    id: 3,
    title: 'Target Audience & Retargeting',
    founder: 'Marketing Webinar',
    company: 'Digital Marketing',
    videoUrl: '/videos/video3.mp4',
  },
  {
    id: 4,
    title: 'Tech Career & Skills',
    founder: 'One Day Workshop',
    company: 'Tech Career Explorer',
    videoUrl: '/videos/video4.mp4',
  },
  {
    id: 5,
    title: 'Full Stack & Web Development',
    founder: 'Coding Session',
  ...
  },
  {
    ...
    founder: 'Professional Training',
    company: 'Vision 20 Plus',
    videoUrl: '/videos/video6.mp4',
  },
  {
    id: 7,
    title: 'IT Training & Placement',
    founder: 'Campus Overview',
    company: 'WeGrow Skill Campus',
    videoUrl: '/videos/video7.mp4',
  },
  {
    id: 8,
    title: 'Student Certifications',
    founder: 'Milestone Celebration',
    company: 'Graduation Day',
    videoUrl: '/videos/video8.mp4',
  },
  {
    id: 9,
    title: 'Success Journey & Growth',
    founder: 'Student Testimonials',
    company: 'WeGrow Alumni',
...
export default function SuccessStories({
  ...
  // Start from the second copy of the cards
  // ===================================================
  ...
  useEffect(() => {
    ...
    const smoothContinuousScroll = () => {
      if (sliderRef.current && !isPaused) {
        ...
        // Move back after reaching the second set
        if (
    ...
    >
      ...
      <style>{`
        @keyframes pulseGlow {
          ...
          50% {
            box-shadow: 0 0 32px rgba(245, 158, 11, 0.70);
          }
        }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Watch our workshop highlights, skill development
            sessions, and celebrate student certifications.
          </p>
        </div>
        ...
        <section className="mb-16">
          ...
          <div className="text-center mb-7">
            ...
            >
              Explore our students' achievements and
        ...
        <section className="mb-16">
          ...
          >
            ...
            >
              Hover over cards to watch our expert-led
              sessions and hands-on bootcamps.
            </p>
        ...
        <section className="pt-2">
          ...
          >
            ...
            >
              ...
              >
                Join our upcoming batch, master
                cutting-edge skills, and secure your
