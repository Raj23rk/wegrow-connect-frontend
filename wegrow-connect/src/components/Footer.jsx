...
//                 WEGROW <span style={{ color: theme.orange || '#f3a812' }}>B SCHOOL</span>
//               </span>
//             </div>
//             <p className="text-xs font-medium leading-relaxed" style={{ color: theme.textMuted || '#94a3b8' }}>
// WeGrow B School provides industry-focused Business and IT training in Business Management, Entrepreneurship, Digital Marketing, Data Analytics, Software Development, and placement-oriented skill programs.
//             </p>
...
export default function Footer({
  ...
  const branchData = {
    sivakasi: {
      // NEW / CURRENT ADDRESS
      address:
        '193/1A, Ground Floor, Ayyapan Kovil Opp. Police Station Road, Sivakasi – 626 123',

      // OLD ADDRESS
      oldAddress:
        '100A/5, 1st Floor, Thiruthangal Road, Opposite Bell Hotel, Sivakasi – 626123',
    ...
    srivilliputtur: {
      address:
        '129, North Car Street, Opposite Bombay Textiles, Upstairs Pathras Kids & Gift Shop, Srivilliputtur – 626125',
  ...
  const quickLinks = [
    ...
    {
      name: 'Seminars',
      action: scrollToSeminars
    },
    {
      name: 'Visits',
      action: scrollToVisits
    },
    {
      name: 'Workshops',
    ...
    {
      name: 'Rewards',
      action: scrollToRewards
    },
    {
      name: 'Mentors / Instructors',
      action: scrollToMentors
    },
    {
      name: 'Enterprise / Corporate Training',
      action: scrollToEnterprices
    },
    {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              WeGrow B School provides
              industry-focused Business and IT
              training in Business Management,
              Entrepreneurship, Digital Marketing,
              Data Analytics, Software Development,
              and placement-oriented skill programs.
            </p>
          ...
          >
            ...
            >
              ...
              {/* OLD ADDRESS - ONLY FOR SIVAKASI */}

              {activeBranch === 'sivakasi' &&
                currentBranch.oldAddress && (
                  <div
                    className="
                      flex
                      items-start
        ...
        >
          <p>
            ...
            WeGrow B School | Business & IT
            Training Institute in Sivakasi &
            Srivilliputhur. All rights reserved.
          </p>
        </div>
