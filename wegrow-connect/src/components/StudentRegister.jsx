...
export default function StudentRegister() {
  ...
  const studentSlides = [
    ...
    },
    {
      ...
      desc: "Get verified certifications, internship opportunities, and direct placement support to fast-track your professional journey."
    }
  ];
      ...
      <div className="w-full max-w-6xl mx-auto px-4 flex items-center justify-center page-fade gap-6">
        ...
        <div className="w-full lg:w-7/12 p-6 sm:p-10 overflow-y-auto custom-scroll max-h-[90vh] bg-white rounded-3xl shadow-2xl border border-gray-200/80">
          <div className="mb-6 flex items-center justify-between">
            <div>
              <h3 className="text-2xl font-black text-[#104288]">Student Register</h3>
              <p className="text-xs font-semibold text-[#f97316] mt-1">Create your student account. It's free and only takes a minute.</p>
            </div>
            <button 
              type="button"
              onClick={() => navigate('/home/login/option')}
          ...
          <form onSubmit={handleRegister} className="w-full flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-[11px] font-bold text-[#104288] uppercase tracking-wider">College Name</label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="text-[11px] font-bold text-[#104288] uppercase tracking-wider">Course</label>
                {renderCustomDropdown('course', 'Select or type course')}
              </div>
              <div>
                <label className="text-[11px] font-bold text-[#104288] uppercase tracking-wider">Department</label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="text-[11px] font-bold text-[#104288] uppercase tracking-wider">Year</label>
                {renderCustomDropdown('year', 'Select or type year')}
              </div>
              <div>
                <label className="text-[11px] font-bold text-[#104288] uppercase tracking-wider">Skills</label>
            ...
            <div className="w-full flex flex-col gap-1.5 pt-1">
              <label className="text-[11px] font-bold text-[#104288] uppercase tracking-wider">Upload ID Proof (College ID / Govt ID)</label>
              <input 
                type="file" 
                accept="image/*,.pdf" 
            ...
            <div className="pt-3">
              <button 
                type="submit" 
                className="register-dir-btn w-full py-3.5 rounded-full font-extrabold text-white text-sm uppercase tracking-wider border-none cursor-pointer shadow-lg bg-[#104288] hover:bg-[#f97316] transition-all"
              >
                REGISTER
              </button>
            </div>
