                        ...
                        <tr key={id} className="hover:bg-slate-50/60 transition">
                          ...
                          <td className="py-3.5 px-4">
                            <div className="flex items-center gap-3 min-w-0">
                              <div className="w-9 h-9 rounded-full bg-orange-100 text-[#F0791E] flex items-center justify-center font-bold text-xs font-mono flex-shrink-0 shadow-sm">
                                {item.fullName
                                  ? item.fullName
                                      .split(' ')
                                      .map((n: string) => n[0])
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <div className="flex flex-col text-[11px] text-slate-500 font-mono mt-0.5 leading-tight">
                                  <a href={`tel:${item.phone}`} className="hover:text-[#F0791E] transition flex items-center gap-1 truncate">
                          ...
                          <td className="py-3.5 px-4">
                            <div className="min-w-0">
                              <div className="font-semibold text-slate-900 truncate" title={item.collegeName || item.college || '—'}>
                          ...
                          {/* Year & Batch */}
                          <td className="py-3.5 px-4">
                            <span className="inline-block px-2 py-0.5 rounded-md text-[10px] font-bold bg-amber-50 text-amber-800 border border-amber-200 truncate max-w-full">
                              {item.yearOfStudy || '—'}
                            </span>
